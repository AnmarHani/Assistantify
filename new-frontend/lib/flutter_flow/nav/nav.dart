...
const debugRouteLinkMap = {
  '/welcomePage':
      'https://app.flutterflow.io/project/assistentify-b1d861?tab=uiBuilder&page=WelcomePage',
  '/loginPage':
  ...
  '/homePage':
      'https://app.flutterflow.io/project/assistentify-b1d861?tab=uiBuilder&page=HomePage',
  '/quesitonsPage':
      'https://app.flutterflow.io/project/assistentify-b1d861?tab=uiBuilder&page=QuesitonsPage',
  '/careerQuestions':
      'https://app.flutterflow.io/project/assistentify-b1d861?tab=uiBuilder&page=CareerQuestions',
  '/fitnessQuestions':
      'https://app.flutterflow.io/project/assistentify-b1d861?tab=uiBuilder&page=FitnessQuestions',
  '/chatPage':
      'https://app.flutterflow.io/project/assistentify-b1d861?tab=uiBuilder&page=chatPage'
};
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => ChatPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => ChatPageWidget(),
        ),
        FFRoute(
          name: 'WelcomePage',
          path: '/welcomePage',
        ...
        FFRoute(
          name: 'QuesitonsPage',
          path: '/quesitonsPage',
          builder: (context, params) => QuesitonsPageWidget(),
        ),
        FFRoute(
          name: 'CareerQuestions',
          path: '/careerQuestions',
          builder: (context, params) => CareerQuestionsWidget(),
        ),
        FFRoute(
          name: 'FitnessQuestions',
          path: '/fitnessQuestions',
          builder: (context, params) => FitnessQuestionsWidget(),
        ),
        FFRoute(
          name: 'chatPage',
          path: '/chatPage',
